...
### Install basic tools
## zsh -c "$(curl -fsSL https://raw.githubusercontent.com/Onfroygmx/dot/main/.dot/install.zsh)"
...
for plug in $PLUGINS; do
    ...
    git clone --recursive --shallow-submodules --depth=1 https://github.com/$plug.git $PLUGIN_DIR/$plug
done
